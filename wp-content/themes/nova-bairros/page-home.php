    ...
    <section class="empreendimentos">
        <div class="container">
            ...
            <div class="relative container-swiper">
                ...
                <div class='emp-prev hidden float-prev 2xl:block'></div>
                <div class='emp-next hidden float-next 2xl:block'></div>
            </div>

            <div class="flex items-center 2xl:justify-center justify-between my-12">
                <div class='emp-prev block 2xl:hidden'></div>
                <a href="/empreendimentos" class="cta h-full 2xl:w-auto text-nowrap my-auto">
                    Ver todos empreendimentos
                </a>
                <div class='emp-next block 2xl:hidden'></div>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-12 items-start lg:items-center">
                <div class="col-span-12 lg:col-span-6 order-1 lg:order-0 min-w-0 w-full">
                    <div class="hidden lg:flex flex-col items-start w-fit gap-2">
                        ...
                        <p class="!mb-6"><?= $textos['texto']; ?></p>
                    </div>
                    <div class="flex flex-col items-start w-fit gap-4">
                        <div class="loc flex flex-row items-center gap-3 map-estado hidden">
                ...
                <div class="col-span-12 lg:col-span-6 lg:order-1 order-0">
                    <div class="flex lg:hidden flex-col items-start w-fit gap-3">
                        <span>Localizações</span>
                        <h2>
                            <?= $textos['titulo']; ?>
                        </h2>
                    ...
                    if ($the_query->have_posts()) {
                        while ($the_query->have_posts()) {
                            $the_query->the_post();
                            $estado = get_the_terms($post->ID, 'estado');
                            if (empty($estado)) continue;
                            $estado = $estado[0]->name;
                            if (!isset($empreendimentos[$estado])) {
                                $empreendimentos[$estado] = [];
                            }
                            $empreendimentos[$estado][] = [
                                'nome' => get_the_title(),
                                'thumbnail' => get_field('thumbnail')['url'],
                    ...
                    ?>
                    <script>
                        var empreendimentos = <?php echo json_encode($empreendimentos); ?>;
                    </script>
                    <!-- <img src="<?= IMG_URI ?>map.png" alt=""> -->
                    <svg style="max-height: 80vh;padding: 40px 0; width:100%;max-width:700px;" viewBox="0 0 450 460" class="svg-map svg-map-sobre" id="svg-map"><a data-estado="TO">
                            ...
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="358.73" y="161.12" width="30" height="34"></image>
                            <text transform="translate(359.732 210.122)" fill="#FFF">BA</text>

                        </a><a data-estado="SE">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M408.561 191.735c.521-1.505 2.465-.725 3.533-.794 2.273-.164.494-2.738 1.095-3.778 2.026-3.793-2.738-5.999-1.998-10.408 4.024 1.931 9.448 3.397 12.408 6.89 1.343 1.533 5.504 2.656 5.832 4.847-6.822.384-6.901 8.819-11.942 11.572-3.944 2.148-10.434-6.343-8.928-8.329z"></path>
                            <path class="circle" d="M417.324 182.854c6.214 0 11.266 5.035 11.266 11.262 0 6.208-5.052 11.261-11.266 11.261-6.238 0-11.258-5.053-11.258-11.261a11.24 11.24 0 0111.258-11.262z"></path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="407.91" y="149.67" width="30" height="34"></image>
                            <text transform="translate(408.912 198.669)" fill="#FFF">SE</text>

                        </a><a data-estado="PE">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M373.011 167.238c2.709-.795 6.218-14.106 8.325-15.106 4.136-1.986 17.255-1.437 17.8 4.903-.437-.068 8.189-2.273 7.479-1.466 1.7-.711 10.518-4.723 12.599-4.82.274-.013 4.603.905 3.068 2.315-.464.439 4.219 3.698 10.789 3.45 4.66-.176 5.179-3.436 8.627-4.409 5.89-1.67 4.737 3.698 5.589 6.943-1.182 2.684-1.646 5.586-2.74 8.285-1.533 3.792-9.804 9.791-13.39 12.119-7.287 4.778-21.802-4.067-22.762-5.67-.602-.985-2.55-5.121-3.178-5.107a2.806 2.806 0 00-1.287 1.519c-.904-.013-7.256-3.533-7.502-4.655-4.769-1.151-5.425 6.108-8.957 6.19.219.108-8.244 6.681-7.506 3.314 3.591-4.643-5.724-6.477-6.954-7.805z">
                            </path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="400.4" y="116.8" width="30" height="34"></image>
                            <text transform="translate(401.398 165.8)" fill="#FFF">PE</text>

                        </a><a data-estado="AL">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M413.953 169.018c3.78 3.313 9.424 5.505 12.547 5.491 3.229-.013 5.009-3.328 7.421-4.794 1.177-.712 10.297-1.93 9.174 1.042-1.807 4.848-7.122 8.585-10.024 12.789-2.792 2-3.423 7.093-6.354 1.864-3.259.424-3.722-4.424-6.957-4.477-3.668-2.261-7.998-3.769-11.201-6.342 2.056-1.945 4.192-3.232 5.394-5.573z"></path>
                            <path class="circle" d="M436.423 168.763c6.236 0 11.258 5.054 11.258 11.278 0 6.207-5.02 11.259-11.258 11.259-6.241 0-11.263-5.052-11.263-11.259 0-6.225 5.022-11.278 11.263-11.278z"></path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="428.79" y="134.9" width="30" height="34"></image>
                            <text transform="translate(429.79 183.895)" fill="#FFF">AL</text>

                        </a><a data-estado="RN">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M404.698 138.795c2.383-4.027 6.574-6.123 8.49-11.149 1.973-5.107 3.834-5.818 8.764-4.642 5.041 1.207 9.339.837 14.57 1.671 7.534 1.193 6.848 10.968 9.206 16.516-1.919 1.096-13.972.521-15.064-1.657-1.041-2.067-2.904 7.107-5.094 7.3 1.532-5.847-12.654 1.78-5.424-8.683 2.545-3.67-6.302-.808-6.711.725-3.314 5.137-6.218.275-8.737-.081z"></path>
                            <path class="circle" d="M430.827 107.798a11.245 11.245 0 0111.261 11.261c0 6.224-5.02 11.261-11.261 11.261-6.209 0-11.26-5.037-11.26-11.261 0-6.222 5.051-11.261 11.26-11.261z"></path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="421.54" y="74.9" width="30" height="34"></image>
                            <text transform="translate(422.541 123.9)" fill="#FFF">RN</text>

                        </a><a data-estado="CE">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M372.379 104.409c.437-1.368 2.961-3.627 1.043-5.025 12.106-1.328 17.581-.849 27.66 6.723 4.026 3.054 6.822 5.574 10.571 9.147 1.317 1.273 7.614 4.313 7.914 6.164-.054-.316-5.396 3.696-5.997 5.217-1.066 2.684-2.659 6.093-4.3 8.298.025-.055-6.903 3.957-3.532 4.217-4.41 3.821-1.015 8.135-.797 11.517.196 2.767-4.38 7.587-6.765 5.422-2.244-1.999-3.998-5.711-7.779-5.094-1.998.329-5.476 2.189-7.612.479-2.52-2.054 3.669-5.162-.545-7.354-6.987-3.615-1.264-15.393-6.684-20.239-3.504-3.136 1.753-7.313.109-10.749-.713-1.452-1.971-7.888-3.286-8.723.656-2.095 2.436 1.562 0 0z">
                            </path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="385.84" y="80.04" width="30" height="34"></image>
                            <text transform="translate(386.838 129.035)" fill="#FFF">CE</text>

                        </a><a data-estado="PI">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M320.781 185.478c2.465-5.149-7.505-20.801-7.505-20.801s47.354-65.868 54.285-66.841c.299-.042 6.243 1.768 6.463 2.219.438.863-.821 5.244-.685 6.587.275 2.629 2.879 6.587 2.328 8.684-1.15 4.736-1.863 6.134 1.369 9.901 2.794 3.245.325 10.16 2.544 14.269-1.778 4.23 4.768 3.656 3.943 7.613-.655 3.163-5.424 7.655-1.176 10.312.274 4.642-4.685 4.983-6.79 7.818-2.631 2.835-5.535 5.013-7.999 7.888-.55.671-8.821 4.096-9.998 4.082.302-.301-17.665-6.449-11.967 2.354 2.463 3.808-1.505 5.56-3.177 8.778-.633 2.164-5.836.958-7.836 3.205-6.404 7.202-7.171-10.819-13.799-6.068z">
                            </path>
                            <image href="<?php echo get_template_directory_uri(); ?>/assets/img/pin.png" x="354.13" y="109.11" width="30" height="34"></image>
                            <text transform="translate(355.127 158.105)" fill="#FFF">PI</text>

                        </a><a data-estado="MA">
                            <path class="" stroke="#FFF" stroke-width="1.04" stroke-linecap="round" stroke-linejoin="round" d="M288.845 127.827c4.108-2.726 31.195-48.985 31.386-50.395 1.235.397 6.084 7.435 7.562 5.025.493.013-.328 2.15-.547 2.396-.054-.135 2.189-2.286 2.52-2.436.521-.233 1.948 1.903 3.451-.726 5.642 1.575 1.314 14.31 9.121 11.694-1.147.384 1.452.74.848 1.905 5.095-6.587 8.488-.027 15.337 1.491 2.025.466 6.243.575 8.162.207 3.808-.823-2.082 6.847-2.082 6.887-1.369 2.986-5.041 1.713-6.818 5.683-.684 1.549-3.506 4.327-3.042 6.148.494 1.781 2.081 2.863.274 4.629.603 2.793 3.066 7.109-.385 9.12-4.601 4.383 2.304 7.52 1.316 11.598-.9 3.726-6.244 5.725-9.147 2.78-4.847-.11-6.872 3.821-10.406 6.45-2.74 2.041-8.793 2.493-10.327 5.642-1.918 3.929-3.699 8.763-5.341 12.79-1.699 4.204 6.383 18.762-4.328 15.611-.932-.273-3.396-4.725-3.396-5.738-.081-3.739-2.738-4.176-4.821-7.477.356-3.025 2.466-6.929 4.766-8.052 3.342-1.63 1.919-6.629-2.466-4.465-3.505 1.726-4.709-2.794-6.958-5.287.548.59-3.064-4.696-3.146-3.697.19-1.89 2.876-5.833 3.341-8.448.575-3.259.52-6.764-.521-10.105-.63-2.068-4.656-4.521-6.518-4.437-1.289.287-2.443 0-3.427-.878-2.27-.067-2.27 2.302-4.408 2.085z">
                            </path>
        ...
        <section class="app">
            <div class="container">
                <div
                    ...
                    <div class="flex flex-col items-center xl:items-start text-white justify-center">
    ...
    <section class="empreendimentos">
        <div class="container">
            ...
            <div class="relative container-swiper">
                ...
                <div class='blog-prev hidden float-prev 2xl:block'></div>
                <div class='blog-next hidden float-next 2xl:block'></div>
            </div>
            <div class="flex items-center justify-between 2xl:justify-center my-12">
                <div class='blog-prev 2xl:hidden'></div>
                <a href="/blog" class="cta h-full lg:w-auto text-nowrap my-auto">
                    Ver todas as notícias
                </a>
                <div class='blog-next 2xl:hidden'></div>
            </div>
        </div>
    </section>
</main>
...
<script>
    $('.svg-map text').each(function() {
        if ($(this).text() in empreendimentos) {
            $(this).show();
            $(this).closest('a')[0].classList.add('show')
    ...
    function initSwiperMap() {
        return new Swiper('.swiper-map', {
            direction: 'horizontal',
            // Disable loop dynamically if there are not enough slides to prevent duplicates/bugs
            loop: ($('.swiper-map .swiper-slide').length > 2),
            spaceBetween: 24,
            breakpoints: {
                576: {
                    slidesPerView: 1
    ...
    swiperMap = null; // Do not initialize on load since it's hidden
    ...
    // Handle map click
    $('.svg-map a[data-estado].show').on('click', function(e) {
        e.preventDefault();
        ...
        if (stateNames[estado]) {
            ...
            $('.btn-readmore').text('Ver mais empreendimentos em ' + stateNames[estado]);
        ...
        $.post(ajaxurl, {
            ...
            if (response.trim().length > 0) {
                ...
                // Re-initialize swiper with the new DOM elements
